...
# [23, 19, 20, 20, 20, 30, 21, 22, 23, 15, 21, 15, 22, 17, 18, 16, 17, 19, 13, 15, 21, 19, 23, 17, 19, 20, 12]
list_of_passengers_count = get_list_of_passengers_count()
bus_data = get_bus_data()
merged_bus_data_and_passengers_count_list = bus_data_and_passengers_count_merge(
    bus_data, list_of_passengers_count)
